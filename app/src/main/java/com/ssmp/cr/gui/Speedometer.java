...
import com.ssmp.cr.gui.util.SeekArc;
...
public class Speedometer {
    ...
    public Speedometer(Activity activity)
    {
        ...
        activity.runOnUiThread(() -> {
            ...
            turnlight_tick_sound_1 = Samp.soundPool.load(Samp.getInstance(), R.raw.turnlight_tick_1, 0);
            turnlight_tick_sound_2 = Samp.soundPool.load(Samp.getInstance(), R.raw.turnlight_tick_2, 0);
