...
import static com.ssmp.launcher.config.Config.DOWNLOAD_DIRECTORY_NAME;
import static com.ssmp.launcher.config.Config.LIVE_RUSSIA_RESOURCE_SERVER_URL;
import static com.ssmp.launcher.config.Config.UPDATED_APK_PATH;
...
import com.ssmp.launcher.async.task.CacheChecker;
import com.ssmp.launcher.async.task.DownloadTask;
