...
public class Config {
    ...
    public static final String FILE_INFO_URL = "https://liverussia.online/downloads/files/files.json";
    ...
    public static final String LIVE_RUSSIA_RESOURCE_SERVER_URI = "https://liverussia.online";
