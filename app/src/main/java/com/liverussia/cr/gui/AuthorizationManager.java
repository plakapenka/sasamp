...
public class AuthorizationManager {
    ...
    native void loginClick(String pass);
        ...
        activity.runOnUiThread(()-> {
            ...
            auth_play.setOnClickListener(view -> {
                ...
                if (auth_password.getText().length() > 5) {
                    loginClick(auth_password.getText().toString());
                }
            });
    ...
    void show(String nick, int id, boolean ip_match, boolean toggle_autologin, boolean email_acvive)
    {
        activity.runOnUiThread(()-> {
            if (email_acvive) {
