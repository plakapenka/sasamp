...
FILE_LIST += $(wildcard $(LOCAL_PATH)/game/Core/*.cpp)
FILE_LIST += $(wildcard $(LOCAL_PATH)/game/Collision/*.cpp)
...
LOCAL_CPPFLAGS := -w -s -fvisibility=hidden -pthread -Wall -fpack-struct=1 -O2 -std=c++17 -fexceptions -fstack-protector
