...
Java_com_sasamp_cr_gui_Speedometer_sendClick(JNIEnv *env, jobject thiz, jint click_id) {
    switch(click_id)
    {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_sasamp_cr_gui_tunings_Colors_color_1change(JNIEnv *env, jobject thiz, jint type,
