...
Java_com_sasamp_cr_gui_TechIspect_init(JNIEnv *env, jobject thiz) {
    CTechInspect::thiz = env->NewGlobalRef(thiz);
}
extern "C"
JNIEXPORT void JNICALL
Java_com_sasamp_cr_gui_TechIspect_sendClick(JNIEnv *env, jobject thiz)
{
...
extern "C"
JNIEXPORT void JNICALL
Java_com_sasamp_cr_gui_TechIspect_exit(JNIEnv *env, jobject thiz) {
    CTechInspect::bIsShow = false;
}