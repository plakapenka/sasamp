...
Java_com_ssmp_cr_gui_CasinoDice_CasinoInit(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_ssmp_cr_gui_Casino_1LuckyWheel_initCasino_1LuckyWheel(JNIEnv *env, jobject thiz) {
