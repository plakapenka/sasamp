...
Java_com_sasamp_cr_gui_HudManager_SendChatButton(JNIEnv *env, jobject thiz, jint button_id) {
	CKeyBoard::dop_butt = button_id;
}
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_sasamp_cr_gui_HudManager_isAndroidKeyboard(JNIEnv *env, jobject thiz) {
