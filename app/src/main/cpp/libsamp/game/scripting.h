...
const SCRIPT_COMMAND apply_animation = { 0x0605, "issfiiiii" }; // actor,animation,library,floatunk,bool,bool,bool,bool,int
...
const SCRIPT_COMMAND toggle_radar_blank = { 0x0581, "b" }; // адрес верный, не работает
