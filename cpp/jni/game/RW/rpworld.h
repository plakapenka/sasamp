...
struct RpLight
{
        RwObjectHasFrame    object; /**< object */                              // 000-020
        RwReal              radius; /**< radius */                              // 020-024
        RwRGBAReal          color; /**< color */  /* Light color */             // 024-028
        RwReal              minusCosAngle; /**< minusCosAngle */                // 028-032
        RwLinkList          WorldSectorsInLight; /**< WorldSectorsInLight */    // 032-040
        RwLLLink            inWorld; /**< inWorld */                            // 040-048
        RwUInt16            lightFrame; /**< lightFrame */                      // 048-050
        RwUInt16            pad;                                                // 050-052
};
#endif /* (!defined(DOXYGEN)) */
